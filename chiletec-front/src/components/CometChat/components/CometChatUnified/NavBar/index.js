      ...
      <div css={footerStyle()}>
        <div css={navbarStyle()}>
          <div css={itemStyle()} onClick={() => props.actionGenerated('tabChanged', 'conversations')}>
            <Popover title="Conversaciones" content={"Aquí puedes ver las conversaciones pendiente y activas"} placement="topLeft" arrowPointAtCenter><span css={itemLinkStyle(chatGreyIcon, chatBlueIcon, chatsTabActive)}></span></Popover>
          </div>
