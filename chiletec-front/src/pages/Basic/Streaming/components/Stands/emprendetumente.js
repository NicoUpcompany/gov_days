...
import header from "../../../../../assets/images/stands/emprendetumente/header.jpg";
import logoInterno from "../../../../../assets/images/stands/emprendetumente/logo-interno.jpg";
import carrusel1 from "../../../../../assets/images/stands/emprendetumente/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/emprendetumente/carrusel2.jpg";
import carrusel3 from "../../../../../assets/images/stands/emprendetumente/carrusel3.jpg";
import carrusel4 from "../../../../../assets/images/stands/emprendetumente/carrusel4.jpg";
import carrusel5 from "../../../../../assets/images/stands/emprendetumente/carrusel5.jpg";
import carrusel6 from "../../../../../assets/images/stands/emprendetumente/carrusel6.jpg";
...
const Emprendetumente = (props) => {
	const { visible, setVisible, token, standName } = props;

	const userID = "610309c64189b858ebb0f7a5";
	...
	return (
		<div className="stand-xl-container">
			<div className="header">
				...
				<img src={logoInterno} alt="Logo" className="logo etm" />
			</div>
			<div className="description-container">
				<p className="description">
					Emprende Tu Mente (ETM) es una Corporación sin fines de lucro que tiene como objetivo generar nuevas y más oportunidades para  emprendedores al conectar el ecosistema de emprendimiento e innovación con grandes empresas, gerentes, mentores e inversionistas, para trabajar colaborativamente en torno al bien común, para generar oportunidades, progreso y un desarrollo social y económico para Chile.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/582593773?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://emprendetumente.org/", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.etmday.org/", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.etmmeet.org/landing", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
			...
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56997678333")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				...
				<a href="mailto:nicolas.uranga@emprendetumente.org">nicolas.uranga@emprendetumente.org</a>
				<a href="tel:+56997678333">+56 9 9767 8333</a>
			</div>
			<Dialog
				open={open}
...
export default Emprendetumente;
