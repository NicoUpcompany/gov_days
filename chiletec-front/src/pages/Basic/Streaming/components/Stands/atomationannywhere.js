...
import header from "../../../../../assets/images/stands/atomationanywhere/header.png";
import carrusel1 from "../../../../../assets/images/stands/atomationanywhere/carrusel1.png";
import carrusel2 from "../../../../../assets/images/stands/atomationanywhere/carrusel2.png";
import carrusel3 from "../../../../../assets/images/stands/atomationanywhere/carrusel3.png";
import carrusel4 from "../../../../../assets/images/stands/atomationanywhere/carrusel4.png";
import carrusel5 from "../../../../../assets/images/stands/atomationanywhere/carrusel5.png";
import carrusel6 from "../../../../../assets/images/stands/atomationanywhere/carrusel6.png";
...
const AtomarionAnywhere = (props) => {
	const { visible, setVisible, token, standName } = props;

	const userID = "610344b5274dde097edd0869";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Automation Anywhere</h1>
				<p className="description">
					La empresa de RPA en la nube Automation 360 es la única plataforma de automatización inteligente nativa de la nube, que permite a
					las empresas trascender los componentes aislados y sistemas de atención al cliente y administración.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/581209072?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/rpa/cloud-rpa", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/products/rpa-workspace", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/products/aari", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/products/iq-bot", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/products/bot-insight", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.automationanywhere.com/la/products/discovery-bot", "_blank")}
						/>
					</div>
				</Carousel>
			</div>
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56965681800")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				...
				<a href="mailto:ingrid.lazarte@automationanywhere.com">ingrid.lazarte@aut...</a>
				<a href="tel:+56965681800">+56965681800</a>
			</div>
			<Dialog
				open={open}
...
export default AtomarionAnywhere;
