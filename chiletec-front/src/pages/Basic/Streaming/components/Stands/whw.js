...
import header from "../../../../../assets/images/stands/whw/header.jpg";
import logoInterno from "../../../../../assets/images/stands/whw/logo-interno.jpg";
import carrusel1 from "../../../../../assets/images/stands/whw/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/whw/carrusel2.jpg";
...
const Whw = (props) => {
	...
	const userID = "60fb31d91a6e19062b20a383";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">WHW Spa</h1>
				<p className="description">
					WHW es un sistema que permite automatizar la medición y estudio de movilidad en las calles, separando entre peatones, ciclistas y
					los distintos modos de transporte motorizados, con cualquier fuente de video, e incluso con la cámara de un smartphone junto a la
					App de WHW.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/435949175?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.whwdata.com/landing", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
			...
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56991395810")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://www.whwdata.com/" target="_blank" rel="noreferrer">
					whwdata.com
				</a>
				<a href="mailto:info@whw.cl">info@whw.cl</a>
				<a href="tel:+56991395810">+56 9 913 95 810</a>
			</div>
			<Dialog
				open={open}
