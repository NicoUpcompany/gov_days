...
import header from "../../../../../assets/images/stands/alfapeople/header.jpg";
import logoInterno from "../../../../../assets/images/stands/alfapeople/logo-interno.jpg";
import carrusel1 from "../../../../../assets/images/stands/alfapeople/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/alfapeople/carrusel2.jpg";
import carrusel3 from "../../../../../assets/images/stands/alfapeople/carrusel3.jpg";
import carrusel4 from "../../../../../assets/images/stands/alfapeople/carrusel4.jpg";
import carrusel5 from "../../../../../assets/images/stands/alfapeople/carrusel5.jpg";
import carrusel6 from "../../../../../assets/images/stands/alfapeople/carrusel6.jpg";
...
const Alfapeople = (props) => {
	const { visible, setVisible, token, standName } = props;

	const userID = "6103058d4189b858ebb0f790";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">AlfaPeople</h1>
				<p className="description">
					AlfaPeople es Partner Gold de Microsoft Dynamics 365, desarrollamos proyectos de consultoría tecnológica y estratégica con alto
					impacto en las Instituciones, enfocados a mejorar y digitalizar sus procesos.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/580518817?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3yefTrm", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3kMPZHp", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3kP3QNr", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3zvV5Mi", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3kQicNK", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://bit.ly/3eS2aPE", "_blank")}
						/>
					</div>
				</Carousel>
			</div>
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56942494535")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://alfapeople.com/latam/" target="_blank" rel="noreferrer">
					alfapeople.com/latam/
				</a>
				<a href="mailto:mhr@alfapeople.com">mhr@alfapeople.com</a>
				<a href="tel:+56227519000">+56 22751 9000</a>
			</div>
			<Dialog
				open={open}
