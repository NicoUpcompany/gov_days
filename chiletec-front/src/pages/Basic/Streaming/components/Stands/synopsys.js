...
import header from "../../../../../assets/images/stands/synopsys/header.jpg";
import carrusel1 from "../../../../../assets/images/stands/synopsys/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/synopsys/carrusel2.jpg";
...
const Synopsys = (props) => {
	...
	const userID = "6103091b4189b858ebb0f7a1";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Synopsys</h1>
				<p className="description">
					Synopsys ayuda a los equipos de desarrollo a crear software seguro y de alta calidad, minimizando los riesgos y maximizando la
					velocidad y la productividad. Synopsys, líder reconocido en seguridad de aplicaciones, proporciona análisis estático, análisis de
					composición de software y soluciones de análisis dinámico que permiten a los equipos encontrar y corregir rápidamente
					vulnerabilidades y defectos en código propietario, componentes de código abierto y comportamiento de aplicaciones. Con una
					combinación de herramientas, servicios y experiencia líderes en la industria, solo Synopsys ayuda a las organizaciones a optimizar
					la seguridad y la calidad en DevSecOps y durante todo el ciclo de vida del desarrollo de software.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/580518539?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.synopsys.com/software-integrity.html", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
			...
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56991588120")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://www.synopsys.com/software-integrity.html" target="_blank" rel="noreferrer">
					synopsys.com
				</a>
				<a href="mailto:contacto@softegrity.cl">contacto@softegrity.cl</a>
				<a href="tel:+56991588120">+56 9 9158 8120</a>
			</div>
			<Dialog
				open={open}
