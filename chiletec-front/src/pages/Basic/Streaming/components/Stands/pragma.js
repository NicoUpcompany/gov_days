...
import header from "../../../../../assets/images/stands/pragma/header.jpg";
import logoInterno from "../../../../../assets/images/stands/pragma/logo-interno.jpg";
import carrusel1 from "../../../../../assets/images/stands/pragma/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/pragma/carrusel2.jpg";
import carrusel3 from "../../../../../assets/images/stands/pragma/carrusel3.jpg";
import carrusel4 from "../../../../../assets/images/stands/pragma/carrusel4.jpg";
import carrusel5 from "../../../../../assets/images/stands/pragma/carrusel5.jpg";
import carrusel6 from "../../../../../assets/images/stands/pragma/carrusel6.jpg";
...
const Pragma = (props) => {
	...
	const userID = "610306ae4189b858ebb0f79a";
	...
	return (
		<div className="stand-xl-container">
			<div className="header">
				...
				<img src={logoInterno} alt="Logo" className="logo pragma" />
			</div>
			<div className="description-container">
				<h1 className="title">Pragma</h1>
				<p className="description">
					Somos una compañía especializada en el diseño, desarrollo, implementación y optimización de servicios y soluciones tecnológicas,
					con más de 23 años de trayectoria. Contamos con una cartera de más de 80 clientes y desde el año 1997 hemos logrado más de 300
					casos de éxito.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/581230580?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://www.pragma.cl/", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
			...
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56992191358")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://www.pragma.cl/" target="_blank" rel="noreferrer">
					pragma.cl
				</a>
				<a href="mailto:roberto.quintanilla@pragma.cl">roberto.quintanilla@pragma.cl</a>
				<a href="tel:+56992191358">+56 9 92191358</a>
			</div>
			<Dialog
				open={open}
