...
import header from "../../../../../assets/images/stands/healthtech/header.jpg";
import logoInterno from "../../../../../assets/images/stands/healthtech/logo-interno.png";
import carrusel1 from "../../../../../assets/images/stands/healthtech/carrusel1.jpg";
import carrusel2 from "../../../../../assets/images/stands/healthtech/carrusel2.jpg";
import carrusel3 from "../../../../../assets/images/stands/healthtech/carrusel3.jpg";
import carrusel4 from "../../../../../assets/images/stands/healthtech/carrusel4.jpg";
import carrusel5 from "../../../../../assets/images/stands/healthtech/carrusel5.jpg";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">HealthTech Group</h1>
				<p className="description">
					HealthTech Group, Powered by Chiletec, es un grupo conformado por 11 empresas chilenas, que desarrollan tecnologías para la salud
					y la medicina. Todas estas empresas, interesadas en la medicina, monitoreo, rehabilitación, tienen en común que sus funciones son
					remotas, adecuándose a la contingencia mundial de la pandemia. Esto permite que los usuarios puedan tener mejoras en los
					servicios. Queremos visibilizar e internacionalizar el trabajo de nuestras empresas, que abarcan software, hardware, apps,
					interoperabilidad, telemedicina, telerehabilitación, entre muchas otras aristas.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/579447015?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://healthtechgroup.cl/", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://healthtechgroup.cl/nosotros", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://healthtechgroup.cl/empresas", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://healthtechgroup.cl/noticias", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://healthtechgroup.cl/contacto", "_blank")}
						/>
					</div>
				</Carousel>
			</div>
			<div className="buttons-container">
				{/* <button className="wsp" onClick={() => openWsp("56222466667")}>
					WhatsApp
				</button> */}
			...
			<div className="footer-container">
				<a href="https://healthtechgroup.cl/" target="_blank" rel="noreferrer">
					healthtechgroup.cl
				</a>
				<a href="mailto:healthtech@chiletec.org">healthtech@chiletec.org</a>
