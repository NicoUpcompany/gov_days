		...
		<div className="stand-xl-container">
			...
			<div className="description-container">
				...
				<p className="description">
					Desde 1997, Ediciones EMB publica las revistas Channel News, orientada al canal de distribución TIC, y Gerencia, para los
					tomadores de decisión de medianas y grandes empresas.
				</p>
			</div>
			{/* {visible ? (
