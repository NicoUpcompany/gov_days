...
import header from "../../../../../assets/images/stands/asimov/header.png";
import logoInterno from "../../../../../assets/images/stands/asimov/logo-interno.png";
import carrusel1 from "../../../../../assets/images/stands/asimov/carrusel1.png";
import carrusel2 from "../../../../../assets/images/stands/asimov/carrusel2.png";
import carrusel3 from "../../../../../assets/images/stands/asimov/carrusel3.png";
import carrusel4 from "../../../../../assets/images/stands/asimov/carrusel4.png";
import carrusel5 from "../../../../../assets/images/stands/asimov/carrusel5.png";
import carrusel6 from "../../../../../assets/images/stands/asimov/carrusel6.png";
...
const Asimov = (props) => {
	...
	const userID = "610300d74189b858ebb0f781";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Asimov</h1>
				<p className="description">
					Apoyamos a tu organización aportando valor a través del uso de tecnologías para conseguir resultados de alto impacto. Combinamos
					conocimiento, experiencia y visión con diseño, desarrollo y gestión de proyectos digitales, tanto para el mercado público y como
					el privado.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/579446770?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://asimov.cl/servicios", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
