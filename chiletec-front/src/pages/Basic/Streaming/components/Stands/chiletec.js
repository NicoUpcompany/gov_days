...
import header from "../../../../../assets/images/stands/chiletec/header.png";
import logoInterno from "../../../../../assets/images/stands/chiletec/logo-interno.jpg";
import carrusel1 from "../../../../../assets/images/stands/chiletec/carrusel1.png";
import carrusel2 from "../../../../../assets/images/stands/chiletec/carrusel2.png";
import carrusel3 from "../../../../../assets/images/stands/chiletec/carrusel3.png";
import carrusel4 from "../../../../../assets/images/stands/chiletec/carrusel4.png";
import carrusel5 from "../../../../../assets/images/stands/chiletec/carrusel5.png";
import carrusel6 from "../../../../../assets/images/stands/chiletec/carrusel6.png";
	...
	return (
		<div className="stand-xl-container">
			...
			<div className="description-container">
				<h1 className="title">Chiletec</h1>
				<p className="description">
					Estamos comprometidos a apoyar el negocio de nuestros socios y de desarrollo de la industria tecnológica. Te invitamos a ser socio
					y sumarte a esta gran iniciativa.
				</p>
			</div>
			{visible ? (
				<div className="video-container">
					<iframe
						...
						height="315"
						className="video"
						src="https://player.vimeo.com/video/499625991?autoplay=1&loop=1&autopause=0"
						frameBorder="0"
				...
				<Carousel dotPosition="bottom" autoplay {...settings}>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/iniciativas/mesas-de-trabajo", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/socios/nuestros-socios", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/capacitacion", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/socios/sumate-a-chiletec", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/eventos", "_blank")}
						/>
					</div>
					<div className="image">
						<LazyLoadImage
							...
							width="100%"
							effect="blur"
							onClick={() => window.open("https://chiletec.org/emprendimiento", "_blank")}
						/>
					</div>
				</Carousel>
			</div>
			<div className="buttons-container">
				<button className="wsp" onClick={() => openWsp("56989003439")}>
					WhatsApp
				</button>
			...
			<div className="footer-container">
				<a href="https://chiletec.org/" target="_blank" rel="noreferrer">
					chiletec.org
				</a>
				<a href="mailto:contacto@chiletec.org">contacto@chiletec.org</a>
				<a href="tel:+56989003439">+56 9 890 03 439</a>
			</div>
			<Dialog
				open={open}
