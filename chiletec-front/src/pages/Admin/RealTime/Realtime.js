			...
			users.forEach((item) => {
				try {
					const dataUpdated = {
						...
						conectionTime2: moment(item.conectionTime * 1)
							.add(3, "hours")
							.format("LLL"),
					};
				...
				<div className="realtime">
					<div className="mapa">
						{countries.length > 0 ? (
							...
							<h1>No hay usuarios conectados</h1>
						)}
					</div>
					<div className="container">
						...
						<div className="pie-chart">
							<div className="conexion-info-chart">
								<Pie data={statsDataDoughnut} />
							</div>
							<div className="conexion-info-chart">
								<Bar data={statsData} width={500} height={500} options={{ maintainAspectRatio: false }} />
							</div>
						</div>
						<div className="conexion-info-chart2">
							<Table
								...
								bordered
								pagination={true}
								scroll={{ x: 1500, y: "calc(100vh + 30px)" }}
								sticky
							/>
						</div>
					</div>
